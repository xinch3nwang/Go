...
public class WeatherTipsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(WeatherTipsActivity.this , GoActivity.class);
    ...
    private void showWeather() {
        ...
        //空气质量
        QWeather.getAirNow(WeatherTipsActivity.this, "CN101010100"/*locationNow*/, Lang.ZH_HANS, new QWeather.OnResultAirNowListener() {
